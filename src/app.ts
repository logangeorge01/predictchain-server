...
const bodyParser = require("body-parser"); //middleware required to handle POST requests (npm install --save body-parser)

var url = "mongodb://localhost:27017/"; //address to local mongoDB
...
app.post("/event", (req: Request, res: Response) => {
    ...
    MongoClient.connect(url, function(err, db) {
        ...
        var myobj = { wallet_id: walletId, event_name: eventName, event_desc: eventDesc};
